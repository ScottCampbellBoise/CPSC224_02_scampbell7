...
public class AttributeSelectionPanel extends JPanel
{
	...
	JButton colorAddButton, coneAddButton, firingAddButton, finishAddButton, 
		reliabilityAddButton, functionalityAddButton, stabilityAddButton, combinationAddButton;
	...
	public class AttributeListener implements ActionListener
	{
		public void actionPerformed(ActionEvent e)
		{
			if(e.getSource() == colorAddButton) {
				if(masterSearchPanel != null) { masterSearchPanel.addAttribute("Color: " + (String)colorComboBox.getSelectedItem()); } 
				else { masterEditPanel.addAttribute("Color: " + (String)colorComboBox.getSelectedItem()); }
			} else if (e.getSource() == coneAddButton) {
				if(masterSearchPanel != null) { masterSearchPanel.addAttribute("Cone Range: " + (String)lowerConeComboBox.getSelectedItem() + " to " + (String)upperConeComboBox.getSelectedItem()); }
				else { masterEditPanel.addAttribute("Cone Range: " + (String)lowerConeComboBox.getSelectedItem() + " to " + (String)upperConeComboBox.getSelectedItem()); }
			} else if (e.getSource() == firingAddButton) {
				if(masterSearchPanel != null) { masterSearchPanel.addAttribute("Firing: " + (String)firingComboBox.getSelectedItem()); } 
				else { masterEditPanel.addAttribute("Firing: " + (String)firingComboBox.getSelectedItem()); }
			} else if (e.getSource() == finishAddButton) {
				if(masterSearchPanel != null) { masterSearchPanel.addAttribute("Finish: " + (String)finishComboBox.getSelectedItem()); } 
				else { masterEditPanel.addAttribute("Finish: " + (String)finishComboBox.getSelectedItem()); }
			} else if (e.getSource() == reliabilityAddButton) {
				if(masterSearchPanel != null) { masterSearchPanel.addAttribute("Reliability: " + (String)reliabilityComboBox.getSelectedItem()); } 
				else { masterEditPanel.addAttribute("Reliability: " + (String)reliabilityComboBox.getSelectedItem()); }
			} else if (e.getSource() == functionalityAddButton) {
				if(masterSearchPanel != null) { masterSearchPanel.addAttribute("Functionality: " + (String)functionalityComboBox.getSelectedItem()); } 
				else { masterEditPanel.addAttribute("Functionality: " + (String)functionalityComboBox.getSelectedItem()); }
			} else if (e.getSource() == stabilityAddButton) {
				if(masterSearchPanel != null) { masterSearchPanel.addAttribute("Stability: " + (String)stabilityComboBox.getSelectedItem()); } 
				else { masterEditPanel.addAttribute("Stability: " + (String)stabilityComboBox.getSelectedItem()); }
			} else if (e.getSource() == combinationAddButton) {
				if(masterSearchPanel != null) { masterSearchPanel.addAttribute("As Combo: " + (String)combinationComboBox.getSelectedItem()); } 
				else { masterEditPanel.addAttribute("As Combo: " + (String)combinationComboBox.getSelectedItem()); }
			}
		}
	}
}
